...
inline void create_default_params(const std::string& db_folder)
{
    ...
    uint64_t ideal_versioned_pages_buffer_bytes = get_file_size(db_folder + "/from_to_type_edge.leaf")
                                                + get_file_size(db_folder + "/from_to_type_edge.dir")
                                                + get_file_size(db_folder + "/to_type_from_edge.leaf")
                                                + get_file_size(db_folder + "/to_type_from_edge.dir")
                                                + get_file_size(db_folder + "/type_to_from_edge.leaf")
                                                ...
                                                + get_file_size(db_folder + "/key_value_object.leaf")
