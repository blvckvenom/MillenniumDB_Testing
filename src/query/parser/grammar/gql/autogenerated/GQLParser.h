...
public:
  ...
  enum {
    ...
    RuleReturnStatement = 160, RuleWithStatement = 161, RuleReturnStatementBody = 162, 
    ...
    RuleUseGraphClause = 183, RuleAtSchemaClause = 184, RuleBindingVariableReference = 185, 
    RuleElementVariableReference = 186, RulePathVariableReference = 187, 
    RuleParameter = 188, RuleGraphPatternYieldClause = 189, RuleGraphPatternYieldItemList = 190, 
    RuleGraphPatternYieldItem = 191, RuleGraphPattern = 192, RuleMatchMode = 193, 
    RuleRepeatableElementsMatchMode = 194, RuleDifferentEdgesMatchMode = 195, 
    RuleElementBindingsOrElements = 196, RuleEdgeBindingsOrEdges = 197, 
    RulePathPatternList = 198, RulePathPattern = 199, RulePathVariableDeclaration = 200, 
    RuleKeepClause = 201, RuleGraphPatternWhereClause = 202, RulePathPatternPrefix = 203, 
    RulePathModePrefix = 204, RulePathMode = 205, RulePathSearchPrefix = 206, 
    RuleAllPathSearch = 207, RulePathOrPaths = 208, RuleAnyPathSearch = 209, 
    RuleNumberOfPaths = 210, RuleShortestPathSearch = 211, RuleAllShortestPathSearch = 212, 
    RuleAnyShortestPathSearch = 213, RuleCountedShortestPathSearch = 214, 
    RuleCountedShortestGroupSearch = 215, RuleNumberOfGroups = 216, RulePathPatternExpression = 217, 
    RulePathMultisetAlternation = 218, RulePathPatternUnion = 219, RulePathTerm = 220, 
    RulePathFactor = 221, RuleQuantifiedPathPrimary = 222, RuleQuestionedPathPrimary = 223, 
    RulePathPrimary = 224, RuleElementPattern = 225, RuleNodePattern = 226, 
    RuleElementPatternFiller = 227, RuleElementVariableDeclaration = 228, 
    ...
    RuleInsertGraphPattern = 249, RuleInsertPathPatternList = 250, RuleInsertPathPattern = 251, 
    RuleInsertNodePattern = 252, RuleInsertEdgePattern = 253, RuleInsertEdgePointingLeft = 254, 
    RuleInsertEdgePointingRight = 255, RuleInsertEdgeUndirected = 256, RuleInsertElementPatternFiller = 257, 
    RuleLabelAndPropertySetSpecification = 258, RuleLabelExpression = 259, 
    RuleLabelTerm = 260, RuleLabelFactor = 261, RuleLabelPrimary = 262, 
    RuleWildcardLabel = 263, RuleParenthesizedLabelExpression = 264, RuleGraphPatternQuantifier = 265, 
    RuleFixedQuantifier = 266, RuleGeneralQuantifier = 267, RuleLowerBound = 268, 
    RuleUpperBound = 269, RuleSimplifiedPathPatternExpression = 270, RuleSimplifiedDefaultingLeft = 271, 
    RuleSimplifiedDefaultingUndirected = 272, RuleSimplifiedDefaultingRight = 273, 
    RuleSimplifiedDefaultingLeftOrUndirected = 274, RuleSimplifiedDefaultingUndirectedOrRight = 275, 
    RuleSimplifiedDefaultingLeftOrRight = 276, RuleSimplifiedDefaultingAnyDirection = 277, 
    RuleSimplifiedContents = 278, RuleSimplifiedPathUnion = 279, RuleSimplifiedMultisetAlternation = 280, 
    RuleSimplifiedTerm = 281, RuleSimplifiedFactorLow = 282, RuleSimplifiedFactorHigh = 283, 
    RuleSimplifiedQuantified = 284, RuleSimplifiedQuestioned = 285, RuleSimplifiedTertiary = 286, 
    RuleSimplifiedDirectionOverride = 287, RuleSimplifiedOverrideLeft = 288, 
    RuleSimplifiedOverrideUndirected = 289, RuleSimplifiedOverrideRight = 290, 
    RuleSimplifiedOverrideLeftOrUndirected = 291, RuleSimplifiedOverrideUndirectedOrRight = 292, 
    RuleSimplifiedOverrideLeftOrRight = 293, RuleSimplifiedOverrideAnyDirection = 294, 
    RuleSimplifiedSecondary = 295, RuleSimplifiedNegation = 296, RuleSimplifiedPrimary = 297, 
    RuleWhereClause = 298, RuleYieldClause = 299, RuleYieldItemList = 300, 
    RuleYieldItem = 301, RuleYieldItemName = 302, RuleYieldItemAlias = 303, 
    RuleGroupByClause = 304, RuleGroupingElementList = 305, RuleGroupingElement = 306, 
    RuleEmptyGroupingSet = 307, RuleOrderByClause = 308, RuleAggregateFunction = 309, 
    RuleProjectionOptions = 310, RuleProjectionIncludeClause = 311, RuleGeneralSetFunctionType = 312, 
    RuleSetQuantifier = 313, RuleBinarySetFunctionType = 314, RuleSortSpecificationList = 315, 
    RuleSortSpecification = 316, RuleSortKey = 317, RuleOrderingSpecification = 318, 
    RuleNullOrdering = 319, RuleLimitClause = 320, RuleOffsetClause = 321, 
    RuleOffsetSynonym = 322, RuleNestedGraphTypeSpecification = 323, RuleGraphTypeSpecificationBody = 324, 
    RuleElementTypeDefinitionList = 325, RuleElementTypeDefinition = 326, 
    RuleNodeTypeDefinition = 327, RuleNodeTypePattern = 328, RuleNodeTypePhrase = 329, 
    RuleNodeTypeName = 330, RuleNodeTypeFiller = 331, RuleNodeTypeLabelSetDefinition = 332, 
    RuleNodeTypePropertyTypeSetDefinition = 333, RuleEdgeTypeDefinition = 334, 
    RuleEdgeTypePattern = 335, RuleEdgeTypePhrase = 336, RuleEdgeTypeName = 337, 
    RuleEdgeTypeFiller = 338, RuleEdgeTypeLabelSetDefinition = 339, RuleEdgeTypePropertyTypeSetDefinition = 340, 
    RuleFullEdgeTypePattern = 341, RuleFullEdgeTypePatternPointingRight = 342, 
    RuleFullEdgeTypePatternPointingLeft = 343, RuleFullEdgeTypePatternUndirected = 344, 
    RuleArcTypePointingRight = 345, RuleArcTypePointingLeft = 346, RuleArcTypeUndirected = 347, 
    RuleArcTypeFiller = 348, RuleAbbreviatedEdgeTypePattern = 349, RuleAbbreviatedEdgeTypePatternPointingRight = 350, 
    RuleAbbreviatedEdgeTypePatternPointingLeft = 351, RuleAbbreviatedEdgeTypePatternUndirected = 352, 
    RuleNodeTypeReference = 353, RuleSourceNodeTypeReference = 354, RuleDestinationNodeTypeReference = 355, 
    RuleEdgeKind = 356, RuleEndpointDefinition = 357, RuleEndpointPairDefinition = 358, 
    RuleEndpointPairDefinitionPointingRight = 359, RuleEndpointPairDefinitionPointingLeft = 360, 
    RuleEndpointPairDefinitionUndirected = 361, RuleConnectorPointingRight = 362, 
    RuleConnectorUndirected = 363, RuleSourceNodeTypeName = 364, RuleDestinationNodeTypeName = 365, 
    RuleLabelSetDefinition = 366, RulePropertyTypeSetDefinition = 367, RulePropertyTypeDefinitionList = 368, 
    RulePropertyTypeDefinition = 369, RulePropertyValueType = 370, RuleBindingTableType = 371, 
    RuleValueType = 372, RuleTyped = 373, RulePredefinedType = 374, RuleBooleanType = 375, 
    RuleCharacterStringType = 376, RuleByteStringType = 377, RuleMinLength = 378, 
    RuleMaxLength = 379, RuleFixedLength = 380, RuleNumericType = 381, RuleExactNumericType = 382, 
    ...
    RuleTemporalDurationType = 393, RuleDatetimeType = 394, RuleLocaldatetimeType = 395, 
    RuleDateType = 396, RuleTimeType = 397, RuleLocaltimeType = 398, RuleDurationType = 399, 
    RuleReferenceValueType = 400, RuleGraphReferenceValueType = 401, RuleClosedGraphReferenceValueType = 402, 
    RuleOpenGraphReferenceValueType = 403, RuleBindingTableReferenceValueType = 404, 
    RuleNodeReferenceValueType = 405, RuleClosedNodeReferenceValueType = 406, 
    RuleOpenNodeReferenceValueType = 407, RuleEdgeReferenceValueType = 408, 
    RuleClosedEdgeReferenceValueType = 409, RuleOpenEdgeReferenceValueType = 410, 
    RuleListValueTypeName = 411, RuleListValueTypeNameSynonym = 412, RuleFieldTypesSpecification = 413, 
    RuleFieldTypeList = 414, RulePathValueType = 415, RuleNotNull = 416, 
    RuleFieldType = 417, RuleSchemaReference = 418, RuleAbsoluteCatalogSchemaReference = 419, 
    RuleCatalogSchemaParentAndName = 420, RuleRelativeCatalogSchemaReference = 421, 
    RulePredefinedSchemaReference = 422, RuleAbsoluteDirectoryPath = 423, 
    RuleRelativeDirectoryPath = 424, RuleSimpleDirectoryPath = 425, RuleGraphReference = 426, 
    RuleCatalogGraphParentAndName = 427, RuleHomeGraph = 428, RuleGraphTypeReference = 429, 
    RuleCatalogGraphTypeParentAndName = 430, RuleBindingTableReference = 431, 
    RuleCatalogBindingTableParentAndName = 432, RuleProcedureReference = 433, 
    RuleCatalogProcedureParentAndName = 434, RuleCatalogObjectParentReference = 435, 
    RuleReferenceParameter = 436, RuleExternalObjectReference = 437, RuleComparisonPredicateCond = 438, 
    RuleCompOp = 439, RuleNullPredicateCond = 440, RuleNormalizedPredicateCond = 441, 
    RuleDirectedPredicateCond = 442, RuleLabeledPredicateCond = 443, RuleSourceDestinationPredicateCond = 444, 
    RuleUnsignedValueSpecification = 445, RuleUnsignedIntegerSpecification = 446, 
    RuleParameterValueSpecification = 447, RulePredefinedParameter = 448, 
    RuleExpression = 449, RuleExpressionPredicate = 450, RuleExpressionAtom = 451, 
    RuleTruthValue = 452, RuleUnaryOperator = 453, RuleFunctionCall = 454, 
    RuleTensorFunction = 455, RuleNumericFunction = 456, RuleFunctionParameter = 457, 
    RulePropertyReference = 458, RuleOneArgNumericFunctionName = 459, RuleTwoArgNumericFunctionName = 460, 
    RuleStringFunction = 461, RuleListFunction = 462, RuleNodeDegreeFunction = 463, 
    RuleCaseFunction = 464, RuleLabelsFunction = 465, RulePropertiesFunction = 466, 
    RuleSimpleWhenClause = 467, RuleSearchedWhenClause = 468, RuleElseClause = 469, 
    RuleWhenOperand = 470, RuleCastFunction = 471, RuleElementIdFunction = 472, 
    RuleDatetimeValueFunction = 473, RuleDateFunction = 474, RuleTimeFunction = 475, 
    RuleLocalTimeFunction = 476, RuleDatetimeFunction = 477, RuleLocalDatetimeFunction = 478, 
    RuleDateFunctionParameters = 479, RuleTimeFunctionParameters = 480, 
    RuleDatetimeFunctionParameters = 481, RuleDateString = 482, RuleTimeString = 483, 
    RuleDatetimeString = 484, RuleDurationFunction = 485, RuleDurationFunctionParameters = 486, 
    RuleDurationString = 487, RuleReduceFunction = 488, RuleGeneralFunction = 489, 
    RuleCollectionValueConstructor = 490, RuleTrimSpecification = 491, RuleNormalForm = 492, 
    RuleListValueConstructor = 493, RuleListComprehension = 494, RuleRecordValueConstructor = 495, 
    RuleField = 496, RulePathValueConstructor = 497, RuleUnsignedLiteral = 498, 
    RuleGeneralLiteral = 499, RuleListLiteral = 500, RuleRecordLiteral = 501, 
    RuleRecordFieldLiteral = 502, RuleKeyword = 503
  };
  ...
  class NodeDegreeFunctionContext;
  ...
  class  GqlProjectFunctionContext : public AggregateFunctionContext {
  public:
  ...
  public:
    ...
    NodeDegreeFunctionContext *nodeDegreeFunction();
  ...
  class  TensorFunctionContext : public antlr4::ParserRuleContext {
  public:
    TensorFunctionContext(antlr4::ParserRuleContext *parent, size_t invokingState);
   
    TensorFunctionContext() = default;
    void copyFrom(TensorFunctionContext *context);
    using antlr4::ParserRuleContext::copyFrom;
  ...
  class  GqlCosineDistanceFunctionContext : public TensorFunctionContext {
  public:
    GqlCosineDistanceFunctionContext(TensorFunctionContext *ctx);

    antlr4::tree::TerminalNode *COSINEDISTANCE();
    antlr4::tree::TerminalNode *LEFT_PAREN();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *TOINTEGER();
    antlr4::tree::TerminalNode *TOFLOAT();
  ...
  class  GqlListSizeFunctionContext : public ListFunctionContext {
  public:
    GqlListSizeFunctionContext(ListFunctionContext *ctx);
  ...
  class  GqlNodesOfPathFunctionContext : public ListFunctionContext {
  public:
    GqlNodesOfPathFunctionContext(ListFunctionContext *ctx);
  ...
  class  GqlRelationshipsOfPathFunctionContext : public ListFunctionContext {
  public:
    GqlRelationshipsOfPathFunctionContext(ListFunctionContext *ctx);
  ...
  class  NodeDegreeFunctionContext : public antlr4::ParserRuleContext {
  public:
    NodeDegreeFunctionContext(antlr4::ParserRuleContext *parent, size_t invokingState);
   
    NodeDegreeFunctionContext() = default;
    void copyFrom(NodeDegreeFunctionContext *context);
    using antlr4::ParserRuleContext::copyFrom;
  ...
  class  GqlInDegreeFunctionContext : public NodeDegreeFunctionContext {
  public:
    GqlInDegreeFunctionContext(NodeDegreeFunctionContext *ctx);

    antlr4::tree::TerminalNode *INDEGREE();
    antlr4::tree::TerminalNode *LEFT_PAREN();
    VariableContext *variable();
    antlr4::tree::TerminalNode *RIGHT_PAREN();
  ...
  class  GqlDegreeFunctionContext : public NodeDegreeFunctionContext {
  public:
    GqlDegreeFunctionContext(NodeDegreeFunctionContext *ctx);
  ...
  class  GqlOutDegreeFunctionContext : public NodeDegreeFunctionContext {
  public:
    GqlOutDegreeFunctionContext(NodeDegreeFunctionContext *ctx);

    antlr4::tree::TerminalNode *OUTDEGREE();
    antlr4::tree::TerminalNode *LEFT_PAREN();
    VariableContext *variable();
    antlr4::tree::TerminalNode *RIGHT_PAREN();
