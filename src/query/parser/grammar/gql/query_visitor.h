...
public:
    ...
    std::any visitProjectionOptions(GQLParser::ProjectionOptionsContext* ctx) override;
    std::any visitProjectionIncludeClause(GQLParser::ProjectionIncludeClauseContext* ctx) override;
