...
**Assemble-optimization continuation (2026-06-30, same branch, NOT pushed) — where the real epoch wins are:**
...
### Offline computation-graph blocks + self-contained blocks (delivered 2026-06-08, on `feature-GNN`, NOT yet pushed)
