...
- Master plan: `docs/superpowers/plans/2026-04-23-projection-compression-stack-plan.md` §8, §16
...
8. **Documentation:**
   ...
   - `CLAUDE.md` subsection committed (tracked).
