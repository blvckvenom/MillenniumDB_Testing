...
public:
  enum {
    ...
    K_IN = 23, K_INSERT = 24, K_INTEGER = 25, K_INTO = 26, K_IS = 27, K_FALSE = 28, 
    K_FLOAT = 29, K_GROUP = 30, K_GROUPS = 31, K_IDENTITY = 32, K_LABELS = 33, 
    K_LABEL = 34, K_LIMIT = 35, K_MANHATTAN = 36, K_MATCH = 37, K_MAX = 38, 
    K_MIN = 39, K_NFKD_CASEFOLD = 40, K_NORMALIZE = 41, K_OBJECTS = 42, 
    K_OFFSET = 43, K_ON = 44, K_OPTIONAL = 45, K_ORDER = 46, K_OR = 47, 
    K_OUTGOING = 48, K_PREFIX = 49, K_PROPERTIES = 50, K_PROPERTY = 51, 
  ...
  enum {
    ...
    RuleNodeList = 75, RuleExprTypename = 76, RuleKeyword = 77
  };
  ...
  class  ComparisonExprInContext : public ComparisonExprContext {
  public:
    ComparisonExprInContext(ComparisonExprContext *ctx);
  ...
  class  ComparisonExprNotInContext : public ComparisonExprContext {
  public:
    ComparisonExprNotInContext(ComparisonExprContext *ctx);
  ...
  public:
    ...
    antlr4::Token *_tset1526 = nullptr;
  ...
  public:
    ...
    antlr4::Token *_tset1545 = nullptr;
