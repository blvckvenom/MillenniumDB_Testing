...
DB_DIR="/tmp/mdb_cora_b5_combined"
LOG="/tmp/mdb_cora_b5_combined.log"
PORT=19902

FEATURE_NAME="cora_combined_b5_zscore"
BASE_FEATURE_NAME="node_features"
GRAPH_NAME="cora_b5_combined_graph"
SAMPLE_NAME="cora_b5_combined_graph_s"
OUTPUT_DIR="cora_b5_combined_train"
SERVER_PID=""
...
run_gql "Create structural features appended to node_features" \
"CALL gnn_create_structural_features('${FEATURE_NAME}', 'Paper', 'CITES', {normalize:'zscore',appendToFeature:'${BASE_FEATURE_NAME}'})
YIELD featureName,nodeCount,featureDim,baseFeatureDim,structuralFeatureDim,fmatPath,rmapPath,normalized,appendedToFeature
RETURN *"
