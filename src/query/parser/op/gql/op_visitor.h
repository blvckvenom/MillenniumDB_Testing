...
public:
    ...
    virtual void visit(OpCallNamed&)
    {
        throw LogicException("visit GQL::OpCallNamed not implemented");
    }
    virtual void visit(OpCallInline&)
    {
        throw LogicException("visit GQL::OpCallInline not implemented");
    }
};
} // namespace GQL
