...
class ExprCosineDistance : public Expr {
public:
    std::unique_ptr<Expr> expr1;
    std::unique_ptr<Expr> expr2;

    ExprCosineDistance(std::unique_ptr<Expr> expr1, std::unique_ptr<Expr> expr2) :
    ...
    {
        return std::make_unique<ExprCosineDistance>(expr1->clone(), expr2->clone());
    }
