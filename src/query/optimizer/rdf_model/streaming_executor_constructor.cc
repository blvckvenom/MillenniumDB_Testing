...
{
    switch (op_show.type) {
    case OpShow::Type::TEXT_INDEX:
        executor = std::make_unique<ShowStreamingExecutor<OpShow::Type::TEXT_INDEX>>();
        break;
    case OpShow::Type::HNSW_INDEX:
        executor = std::make_unique<ShowStreamingExecutor<OpShow::Type::HNSW_INDEX>>();
        break;
    default:
