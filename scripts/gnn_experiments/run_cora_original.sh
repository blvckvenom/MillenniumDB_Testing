...
DB_DIR="/tmp/mdb_cora_original"
LOG="/tmp/mdb_cora_original.log"
PORT=19900

FEATURE_NAME="node_features"
GRAPH_NAME="cora_original_graph"
SAMPLE_NAME="cora_original_graph_s"
OUTPUT_DIR="cora_original_train"
SERVER_PID=""
...
"CALL gnn_build_feature_store('${SAMPLE_NAME}', '${FEATURE_NAME}', {gpu_budget_mb:0,cpu_budget_mb:100,reorder:1,force:0})
