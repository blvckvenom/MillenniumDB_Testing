...
DB_DIR="/tmp/mdb_cora_b6_query_rich"
LOG="/tmp/mdb_cora_b6_query_rich.log"
PORT=19903

FEATURE_NAME="cora_query_rich_features_zscore"
GRAPH_NAME="cora_b6_query_rich_graph"
SAMPLE_NAME="cora_b6_query_rich_graph_s"
OUTPUT_DIR="cora_b6_query_rich_train"
SERVER_PID=""
...
run_gql "Create rich query features" \
"CALL gnn_create_features_from_query('${FEATURE_NAME}', '${FEATURE_QUERY}', {normalize:'zscore'})
